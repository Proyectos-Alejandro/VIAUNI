<?php
        ...
        $stmtmenu = $pdo->query("SELECT OPCION, SECCION FROM menu WHERE ID!=9 AND ID!=10 AND ID!=11 AND ID!=12 AND ID!=3 AND ID!=2 ORDER BY ORDEN ASC"); // OPCIONES DE MENÚ PRINCIPAL SELECCIONA TODAS LAS SECCIONES MENOS LA 9, 10 Y 11 //
        $menupagina = $stmtmenu->fetchAll();

        $stmtmenuusuario = $pdo->query("SELECT OPCION, SECCION FROM MENU WHERE ID=10 or ID=9 ORDER BY ORDEN ASC"); 
...
<div class="menu_container">
        ...
        <div class="perfil">
                        ...
                        <label for="menu-toggle">
                                <img src="../assets/img/perfilusuario/sinfoto.png" alt="sin sesión" class="perfilfoto">
                        </label>
